...
# from keras.layers import Conv2D,BatchNormalization,ReLU,MaxPooling2D,Flatten
import time
...
def create_model():
    ...
    model.add(tf.keras.layers.Conv2D(20,kernel_size=5))
    model.add(tf.keras.layers.BatchNormalization())
    model.add(tf.keras.layers.ReLU())
    model.add(tf.keras.layers.MaxPooling2D(pool_size=2,strides=2,padding="same"))

    model.add(tf.keras.layers.Conv2D(50, kernel_size=5))
    model.add(tf.keras.layers.BatchNormalization())
    model.add(tf.keras.layers.ReLU())
    model.add(tf.keras.layers.MaxPooling2D(pool_size=2, strides=2, padding="same"))
